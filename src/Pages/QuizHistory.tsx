        ...
        if (quizHistoryRes.data != undefined){
            if (quizHistoryRes.data.getAllQuizParticipant != undefined){
              ...
              for (let i = 0; i<arr.length; i++){
                let check = quizHistoryRes.data.getAllQuizParticipant[i].quizConnection.isFinished 
                if (check == true){
                  let quizName = quizHistoryRes.data.getAllQuizParticipant[i].quizConnection.quizName 
                  ...
                  let nav = {
                    ...
                    href : "#",
                    current : false,
                    quizId : quizHistoryRes.data.getAllQuizParticipant[i].quizConnection.id
                  }
              ...
              <div className="h-screen flex overflow-hidden bg-white">
                  ...
                  <div className="hidden md:flex md:flex-shrink-0">
                      ...
                      <div className="flex flex-col h-0 flex-1 border-r border-gray-200">
                          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto bg-indigo-800">
